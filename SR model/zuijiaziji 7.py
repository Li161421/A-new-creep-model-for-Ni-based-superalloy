# -*- coding: utf-8 -*-
"""
Created on Fri Jun 16 21:56:16 2023
               ...
               for e in range(d+1,9,1):
                   for g in range(e+1,9,1):
                       for h in range(g+1,9,1):
                           data_input_normed =  data_input_normed_0[:,(a,b,c,d,e,g,h)]
                           ...
                           for i in [1.0]:  
                               for j in [0.06]:      
                                         ...
                                         print('输入参数：',a,',',b,',',c,',',d,',',e,',',g,' ,',h,'  R2:',mean_score, ' MAE:', mean_MAE,' MSE:',mean_MSE,' RMSE:',mean_RMSE,' MAPE:',mean_MAPE*100)