# -*- coding: utf-8 -*-
"""
Created on Fri Jun 16 16:03:34 2023
    ...
    for b in range(a+1,9,1):
        for c in range(b+1,9,1):
           for d in range(c+1,9,1):
               data_input_normed =  data_input_normed_0[:,(a,b,c,d)]
               ...
               print('输入参数：',a,',',b,',',c,',',d,'   R2:',mean_score, ' MAE:', mean_MAE,' MSE:',mean_MSE,' RMSE:',mean_RMSE,' MAPE:',mean_MAPE*100)
