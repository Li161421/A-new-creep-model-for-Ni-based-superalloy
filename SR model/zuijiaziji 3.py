# -*- coding: utf-8 -*-
"""
Created on Fri Jun 16 15:57:30 2023
...
for a in range(0,9,1):
    for b in range(a+1,9,1):
        for c in range(b+1,9,1):
            data_input_normed =  data_input_normed_0[:,(a,b,c)]
            ...
            print('输入参数:',a,',',b,',',c,';R2:',mean_score, ';MAE:', mean_MAE,';MSE:',mean_MSE,';RMSE:',mean_RMSE,';MAPE:',mean_MAPE*100)
